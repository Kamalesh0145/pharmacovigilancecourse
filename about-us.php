                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                Hands-on exposure through real-world case studies, mock trials, and project simulations to bridge theory with practice.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                            <div class="card-body">
                                Expert mentorship and guidance to help students identify career paths, prepare for interviews, and excel in the pharmaceutical and clinical research industry.
                            </div>
                        </div>
                    </div>
