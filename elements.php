  <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'products_download') {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'New Student Download: Products';
            ...
            header("Location: " . $_SERVER['PHP_SELF'] . "?products_download=success");
            exit();
        } catch (Exception $e) {
  ...
  <body>
      ...
      <div style="text-align: center; margin: 30px 0;">
          ...
          <button type="button" class="download_btn_red" data-toggle="modal" data-target="#downloadProductsModal">
              ⬇️ Products Details
          </button>
      </div>

      <!-- Modal -->
      <div class="modal fade" id="downloadProductsModal" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content" style="border-radius: 15px; overflow: hidden; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                  <div class="modal-header" style="background: #7b2cbf; color: white; border: none; padding: 20px;">
                      <h5 class="modal-title" style="font-weight: 600;">Products Brochure Download</h5>
                      <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                      </button>
                  </div>
                  <form id="productsLeadForm" method="POST" action="">
      ...
      <script>
          ...
          <?php if (isset($_GET['products_download']) && $_GET['products_download'] == 'success'): ?>
              window.onload = function() {
                  showToast();
                  var link = document.createElement('a');
                  link.href = 'img/products.pdf';
                  link.download = 'Cynture_Global_Products.pdf';
